...
=======
  ...
  setPrior(beginningPriority); // set a priority value
   9:	c7 04 24 1e 00 00 00 	movl   $0x1e,(%esp)
  10:	e8 4d 03 00 00       	call   362 <setPrior>
  15:	ba f8 a7 00 00       	mov    $0xa7f8,%edx
  1a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
...
<<<<<<< HEAD
  ...
  31:	75 ed                	jne    20 <main+0x20>
    ...
    printf(1, "Program 2 finished with starting priority: %d\n", getPrior());
  33:	e8 02 03 00 00       	call   33a <getPrior>
  38:	c7 44 24 04 68 07 00 	movl   $0x768,0x4(%esp)
  3f:	00 
  40:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  47:	89 44 24 08          	mov    %eax,0x8(%esp)
  4b:	e8 b0 03 00 00       	call   400 <printf>

    exitStatus(0);
  50:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  57:	e8 c6 02 00 00       	call   322 <exitStatus>
    return 0;
}
...
=======
  ...
  33:	e8 ea 02 00 00       	call   322 <getpid>
  38:	c7 44 24 04 86 07 00 	movl   $0x786,0x4(%esp)
  3f:	00 
  40:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  47:	89 44 24 08          	mov    %eax,0x8(%esp)
  ...
  57:	00 
  58:	c7 44 24 04 a4 07 00 	movl   $0x7a4,0x4(%esp)
  5f:	00 
  60:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  67:	e8 b4 03 00 00       	call   420 <printf>

  exitStatus(0);
  6c:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  73:	e8 ca 02 00 00       	call   342 <exitStatus>
  return 0;
}
...
<<<<<<< HEAD
 ...
 399:	0f b6 92 9f 07 00 00 	movzbl 0x79f(%edx),%edx
  }while((x /= base) != 0);
...
=======
 ...
 3b9:	0f b6 92 c3 07 00 00 	movzbl 0x7c3(%edx),%edx
  }while((x /= base) != 0);
...
<<<<<<< HEAD
 ...
 52f:	8b 38                	mov    (%eax),%edi
          s = "(null)";
 531:	b8 98 07 00 00       	mov    $0x798,%eax
...
=======
 ...
 54f:	8b 38                	mov    (%eax),%edi
          s = "(null)";
 551:	b8 bc 07 00 00       	mov    $0x7bc,%eax
