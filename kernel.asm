...
80100d20:	e8 5b 5c 00 00       	call   80106980 <switchuvm>
  freevm(oldpgdir);
80100d25:	89 34 24             	mov    %esi,(%esp)
80100d28:	e8 b3 5f 00 00       	call   80106ce0 <freevm>
  return 0;
...
80103728:	e8 83 0e 00 00       	call   801045b0 <memset>
...
80103783:	00 
80103784:	c7 44 24 04 85 75 10 	movl   $0x80107585,0x4(%esp)
8010378b:	80 
8010378c:	89 04 24             	mov    %eax,(%esp)
8010378f:	e8 fc 0f 00 00       	call   80104790 <safestrcpy>
  p->cwd = namei("/");
80103794:	c7 04 24 8e 75 10 80 	movl   $0x8010758e,(%esp)
...
801037c8:	c7 04 24 6c 75 10 80 	movl   $0x8010756c,(%esp)
...
8010380a:	e8 c1 33 00 00       	call   80106bd0 <allocuvm>
...
80103819:	e8 62 31 00 00       	call   80106980 <switchuvm>
  return 0;
...
80103c38:	eb 11                	jmp    80103c4b <exitStatus+0x8b>
...
80103c49:	74 1d                	je     80103c68 <exitStatus+0xa8>
    if(p->state == SLEEPING && p->chan == chan)
80103c4b:	83 7a 10 02          	cmpl   $0x2,0x10(%edx)
80103c4f:	75 ef                	jne    80103c40 <exitStatus+0x80>
80103c51:	3b 42 24             	cmp    0x24(%edx),%eax
80103c54:	75 ea                	jne    80103c40 <exitStatus+0x80>
      p->state = RUNNABLE;
80103c56:	c7 42 10 03 00 00 00 	movl   $0x3,0x10(%edx)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103c5d:	83 ea 80             	sub    $0xffffff80,%edx
80103c60:	81 fa 54 4d 11 80    	cmp    $0x80114d54,%edx
80103c66:	75 e3                	jne    80103c4b <exitStatus+0x8b>
      p->parent = initproc;
80103c68:	a1 b8 a5 10 80       	mov    0x8010a5b8,%eax
80103c6d:	b9 54 2d 11 80       	mov    $0x80112d54,%ecx
80103c72:	eb 0f                	jmp    80103c83 <exitStatus+0xc3>
...
80103c81:	74 34                	je     80103cb7 <exitStatus+0xf7>
    if (p->parent == curproc)
80103c83:	39 59 18             	cmp    %ebx,0x18(%ecx)
80103c86:	75 f0                	jne    80103c78 <exitStatus+0xb8>
      if (p->state == ZOMBIE)
80103c88:	83 79 10 05          	cmpl   $0x5,0x10(%ecx)
      p->parent = initproc;
80103c8c:	89 41 18             	mov    %eax,0x18(%ecx)
      if (p->state == ZOMBIE)
80103c8f:	75 e7                	jne    80103c78 <exitStatus+0xb8>
80103c91:	ba 54 2d 11 80       	mov    $0x80112d54,%edx
80103c96:	eb 0b                	jmp    80103ca3 <exitStatus+0xe3>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103c98:	83 ea 80             	sub    $0xffffff80,%edx
80103c9b:	81 fa 54 4d 11 80    	cmp    $0x80114d54,%edx
80103ca1:	74 d5                	je     80103c78 <exitStatus+0xb8>
    if(p->state == SLEEPING && p->chan == chan)
80103ca3:	83 7a 10 02          	cmpl   $0x2,0x10(%edx)
80103ca7:	75 ef                	jne    80103c98 <exitStatus+0xd8>
80103ca9:	3b 42 24             	cmp    0x24(%edx),%eax
80103cac:	75 ea                	jne    80103c98 <exitStatus+0xd8>
      p->state = RUNNABLE;
80103cae:	c7 42 10 03 00 00 00 	movl   $0x3,0x10(%edx)
80103cb5:	eb e1                	jmp    80103c98 <exitStatus+0xd8>
  curproc->state = ZOMBIE;
80103cb7:	c7 43 10 05 00 00 00 	movl   $0x5,0x10(%ebx)
  sched();
...
80103cf7:	c7 40 10 03 00 00 00 	movl   $0x3,0x10(%eax)
  sched();
...
80103d59:	e8 02 08 00 00       	call   80104560 <release>
  p->chan = chan;
80103d5e:	89 7b 24             	mov    %edi,0x24(%ebx)
  p->state = SLEEPING;
80103d61:	c7 43 10 02 00 00 00 	movl   $0x2,0x10(%ebx)
  sched();
80103d68:	e8 93 fc ff ff       	call   80103a00 <sched>
  p->chan = 0;
80103d6d:	c7 43 24 00 00 00 00 	movl   $0x0,0x24(%ebx)
    release(&ptable.lock);
...
80103d8f:	90                   	nop
  p->chan = chan;
80103d90:	89 78 24             	mov    %edi,0x24(%eax)
  p->state = SLEEPING;
80103d93:	c7 40 10 02 00 00 00 	movl   $0x2,0x10(%eax)
  sched();
80103d9a:	e8 61 fc ff ff       	call   80103a00 <sched>
  p->chan = 0;
80103d9f:	c7 43 24 00 00 00 00 	movl   $0x0,0x24(%ebx)
}
...
80103e01:	74 1d                	je     80103e20 <wait+0x50>
      if(p->parent != curproc)
80103e03:	39 73 18             	cmp    %esi,0x18(%ebx)
80103e06:	75 f0                	jne    80103df8 <wait+0x28>
      if(p->state == ZOMBIE){
80103e08:	83 7b 10 05          	cmpl   $0x5,0x10(%ebx)
...
80103e24:	8b 46 28             	mov    0x28(%esi),%eax
...
80103e3b:	eb ae                	jmp    80103deb <wait+0x1b>
        kfree(p->kstack);
80103e3d:	8b 43 0c             	mov    0xc(%ebx),%eax
        pid = p->pid;
80103e40:	8b 73 14             	mov    0x14(%ebx),%esi
        kfree(p->kstack);
...
80103e64:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
        p->parent = 0;
80103e6b:	c7 43 18 00 00 00 00 	movl   $0x0,0x18(%ebx)
        p->name[0] = 0;
80103e72:	c6 43 70 00          	movb   $0x0,0x70(%ebx)
        p->killed = 0;
80103e76:	c7 43 28 00 00 00 00 	movl   $0x0,0x28(%ebx)
        p->state = UNUSED;
80103e7d:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
        release(&ptable.lock);
...
80103ec8:	89 c6                	mov    %eax,%esi
  acquire(&ptable.lock);
80103eca:	e8 21 06 00 00       	call   801044f0 <acquire>
    havekids = 0;
80103ecf:	31 c0                	xor    %eax,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103ed1:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
80103ed6:	eb 0b                	jmp    80103ee3 <waitStatus+0x33>
80103ed8:	83 eb 80             	sub    $0xffffff80,%ebx
80103edb:	81 fb 54 4d 11 80    	cmp    $0x80114d54,%ebx
80103ee1:	74 1d                	je     80103f00 <waitStatus+0x50>
      if(p->parent != curproc)
80103ee3:	39 73 18             	cmp    %esi,0x18(%ebx)
80103ee6:	75 f0                	jne    80103ed8 <waitStatus+0x28>
      if(p->state == ZOMBIE) //Found one
80103ee8:	83 7b 10 05          	cmpl   $0x5,0x10(%ebx)
80103eec:	74 2f                	je     80103f1d <waitStatus+0x6d>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
...
80103efc:	75 e5                	jne    80103ee3 <waitStatus+0x33>
80103efe:	66 90                	xchg   %ax,%ax
    if(!havekids || curproc->killed)
80103f00:	85 c0                	test   %eax,%eax
80103f02:	74 77                	je     80103f7b <waitStatus+0xcb>
80103f04:	8b 46 28             	mov    0x28(%esi),%eax
80103f07:	85 c0                	test   %eax,%eax
80103f09:	75 70                	jne    80103f7b <waitStatus+0xcb>
    sleep(curproc, &ptable.lock);  //DOC: wait-sleep
...
80103f1b:	eb b2                	jmp    80103ecf <waitStatus+0x1f>
        kfree(p->kstack);
80103f1d:	8b 43 0c             	mov    0xc(%ebx),%eax
        pid = p->pid;
80103f20:	8b 73 14             	mov    0x14(%ebx),%esi
        kfree(p->kstack);
80103f23:	89 04 24             	mov    %eax,(%esp)
80103f26:	e8 c5 e3 ff ff       	call   801022f0 <kfree>
        freevm(p->pgdir);
80103f2b:	8b 43 08             	mov    0x8(%ebx),%eax
        p->kstack = 0;
...
80103f38:	e8 a3 2d 00 00       	call   80106ce0 <freevm>
        if (status != 0)
80103f3d:	85 ff                	test   %edi,%edi
        p->pid = 0;
80103f3f:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
        p->parent = 0;
80103f46:	c7 43 18 00 00 00 00 	movl   $0x0,0x18(%ebx)
        p->name[0] = 0;
80103f4d:	c6 43 70 00          	movb   $0x0,0x70(%ebx)
        p->killed = 0;
80103f51:	c7 43 28 00 00 00 00 	movl   $0x0,0x28(%ebx)
        p->state = UNUSED;
80103f58:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
        if (status != 0)
80103f5f:	74 04                	je     80103f65 <waitStatus+0xb5>
          *status = p->exitStatus; //cs153_lab1: return the terminated child exit status through the status argument
80103f61:	8b 03                	mov    (%ebx),%eax
80103f63:	89 07                	mov    %eax,(%edi)
        release(&ptable.lock);
80103f65:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103f6c:	e8 ef 05 00 00       	call   80104560 <release>
}
80103f71:	83 c4 1c             	add    $0x1c,%esp
        return pid;
...
80103f7a:	c3                   	ret    
      release(&ptable.lock);
80103f7b:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103f82:	e8 d9 05 00 00       	call   80104560 <release>
}
80103f87:	83 c4 1c             	add    $0x1c,%esp
      return -1;
...
80103f92:	5d                   	pop    %ebp
80103f93:	c3                   	ret    
80103f94:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80103f9a:	8d bf 00 00 00 00    	lea    0x0(%edi),%edi
...
80103fb8:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  acquire(&ptable.lock);
80103fbb:	e8 30 05 00 00       	call   801044f0 <acquire>
    processExists = 0;
...
80103fd9:	74 1d                	je     80103ff8 <waitpid+0x58>
      if (p->pid != pid)
80103fdb:	8b 7b 14             	mov    0x14(%ebx),%edi
80103fde:	39 f7                	cmp    %esi,%edi
80103fe0:	75 ee                	jne    80103fd0 <waitpid+0x30>
      if (p->state == ZOMBIE) //process exited
80103fe2:	83 7b 10 05          	cmpl   $0x5,0x10(%ebx)
80103fe6:	74 38                	je     80104020 <waitpid+0x80>
    for (p = ptable.proc; p < &ptable.proc[NPROC]; p++)
...
80103ffa:	0f 84 81 00 00 00    	je     80104081 <waitpid+0xe1>
80104000:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80104003:	8b 40 28             	mov    0x28(%eax),%eax
80104006:	85 c0                	test   %eax,%eax
80104008:	75 77                	jne    80104081 <waitpid+0xe1>
    sleep(curproc, &ptable.lock); //DOC: wait-sleep
8010400a:	8b 45 e4             	mov    -0x1c(%ebp),%eax
8010400d:	c7 44 24 04 20 2d 11 	movl   $0x80112d20,0x4(%esp)
80104014:	80 
80104015:	89 04 24             	mov    %eax,(%esp)
80104018:	e8 03 fd ff ff       	call   80103d20 <sleep>
  }
8010401d:	eb a1                	jmp    80103fc0 <waitpid+0x20>
8010401f:	90                   	nop
        kfree(p->kstack);
80104020:	8b 53 0c             	mov    0xc(%ebx),%edx
80104023:	89 14 24             	mov    %edx,(%esp)
80104026:	e8 c5 e2 ff ff       	call   801022f0 <kfree>
        freevm(p->pgdir);
8010402b:	8b 53 08             	mov    0x8(%ebx),%edx
        p->kstack = 0;
8010402e:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        freevm(p->pgdir);
80104035:	89 14 24             	mov    %edx,(%esp)
80104038:	e8 a3 2c 00 00       	call   80106ce0 <freevm>
        if (status != 0)
8010403d:	8b 55 0c             	mov    0xc(%ebp),%edx
        p->pid = 0;
80104040:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
        p->parent = 0;
80104047:	c7 43 18 00 00 00 00 	movl   $0x0,0x18(%ebx)
        p->name[0] = 0;
8010404e:	c6 43 70 00          	movb   $0x0,0x70(%ebx)
        if (status != 0)
80104052:	85 d2                	test   %edx,%edx
        p->killed = 0;
80104054:	c7 43 28 00 00 00 00 	movl   $0x0,0x28(%ebx)
        p->state = UNUSED;
8010405b:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
        if (status != 0)
80104062:	74 07                	je     8010406b <waitpid+0xcb>
          *status = p->exitStatus;
80104064:	8b 13                	mov    (%ebx),%edx
80104066:	8b 45 0c             	mov    0xc(%ebp),%eax
80104069:	89 10                	mov    %edx,(%eax)
        release(&ptable.lock);
8010406b:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80104072:	e8 e9 04 00 00       	call   80104560 <release>
}
80104077:	83 c4 1c             	add    $0x1c,%esp
8010407a:	89 f8                	mov    %edi,%eax
8010407c:	5b                   	pop    %ebx
8010407d:	5e                   	pop    %esi
8010407e:	5f                   	pop    %edi
8010407f:	5d                   	pop    %ebp
80104080:	c3                   	ret    
      release(&ptable.lock);
80104081:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
      return -1;
80104088:	bf ff ff ff ff       	mov    $0xffffffff,%edi
      release(&ptable.lock);
8010408d:	e8 ce 04 00 00       	call   80104560 <release>
      return -1;
80104092:	eb e3                	jmp    80104077 <waitpid+0xd7>
...
80104128:	74 36                	je     80104160 <kill+0x60>
    if(p->pid == pid){
8010412a:	39 58 14             	cmp    %ebx,0x14(%eax)
8010412d:	75 f1                	jne    80104120 <kill+0x20>
      p->killed = 1;
      // Wake process from sleep if necessary.
      if(p->state == SLEEPING)
8010412f:	83 78 10 02          	cmpl   $0x2,0x10(%eax)
      p->killed = 1;
...
8010414f:	c3                   	ret    
        p->state = RUNNABLE;
80104150:	c7 40 10 03 00 00 00 	movl   $0x3,0x10(%eax)
...
80104186:	bb c4 2d 11 80       	mov    $0x80112dc4,%ebx
...
801041a4:	83 eb 80             	sub    $0xffffff80,%ebx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801041a7:	81 fb c4 4d 11 80    	cmp    $0x80114dc4,%ebx
...
801042cd:	8b 40 14             	mov    0x14(%eax),%eax
...
80104357:	3b 58 14             	cmp    0x14(%eax),%ebx
...
80104812:	39 d8                	cmp    %ebx,%eax
80104814:	76 1a                	jbe    80104830 <fetchint+0x30>
80104816:	8d 53 04             	lea    0x4(%ebx),%edx
80104819:	39 d0                	cmp    %edx,%eax
8010481b:	72 13                	jb     80104830 <fetchint+0x30>
    return -1;
  *ip = *(int*)(addr);
8010481d:	8b 45 0c             	mov    0xc(%ebp),%eax
80104820:	8b 13                	mov    (%ebx),%edx
...
80104835:	eb ef                	jmp    80104826 <fetchint+0x26>
...
8010484a:	e8 51 ee ff ff       	call   801036a0 <myproc>
  ...
  if(addr >= curproc->sz)
8010484f:	39 58 04             	cmp    %ebx,0x4(%eax)
80104852:	76 28                	jbe    8010487c <fetchstr+0x3c>
    return -1;
  *pp = (char*)addr;
80104854:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80104857:	89 da                	mov    %ebx,%edx
80104859:	89 19                	mov    %ebx,(%ecx)
  ep = (char*)curproc->sz;
8010485b:	8b 40 04             	mov    0x4(%eax),%eax
  for(s = *pp; s < ep; s++){
8010485e:	39 c3                	cmp    %eax,%ebx
80104860:	73 1a                	jae    8010487c <fetchstr+0x3c>
    if(*s == 0)
80104862:	80 3b 00             	cmpb   $0x0,(%ebx)
80104865:	75 0e                	jne    80104875 <fetchstr+0x35>
80104867:	eb 1f                	jmp    80104888 <fetchstr+0x48>
80104869:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80104870:	80 3a 00             	cmpb   $0x0,(%edx)
80104873:	74 13                	je     80104888 <fetchstr+0x48>
  for(s = *pp; s < ep; s++){
...
801048ff:	8b 46 04             	mov    0x4(%esi),%eax
80104902:	39 c2                	cmp    %eax,%edx
80104904:	73 1a                	jae    80104920 <argptr+0x50>
80104906:	01 d3                	add    %edx,%ebx
80104908:	39 d8                	cmp    %ebx,%eax
8010490a:	72 14                	jb     80104920 <argptr+0x50>
    return -1;
  *pp = (char*)i;
8010490c:	8b 45 0c             	mov    0xc(%ebp),%eax
8010490f:	89 10                	mov    %edx,(%eax)
  return 0;
}
80104911:	83 c4 20             	add    $0x20,%esp
  return 0;
...
80104978:	e8 23 ed ff ff       	call   801036a0 <myproc>
  ...
  num = curproc->tf->eax;
8010497d:	8b 70 1c             	mov    0x1c(%eax),%esi
  struct proc *curproc = myproc();
...
801049a8:	89 44 24 0c          	mov    %eax,0xc(%esp)
            curproc->pid, curproc->name, num);
801049ac:	8d 43 70             	lea    0x70(%ebx),%eax
801049af:	89 44 24 08          	mov    %eax,0x8(%esp)
    cprintf("%d %s: unknown sys call %d\n",
801049b3:	8b 43 14             	mov    0x14(%ebx),%eax
...
801049c1:	e8 8a bc ff ff       	call   80100650 <cprintf>
    curproc->tf->eax = -1;
801049c6:	8b 43 1c             	mov    0x1c(%ebx),%eax
...
801049f0:	8b 4c 90 2c          	mov    0x2c(%eax,%edx,4),%ecx
...
80104a0c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      curproc->ofile[fd] = f;
80104a10:	89 5c 90 2c          	mov    %ebx,0x2c(%eax,%edx,4)
}
...
80104bd1:	8b 44 90 2c          	mov    0x2c(%eax,%edx,4),%eax
...
80104d4d:	c7 44 90 2c 00 00 00 	movl   $0x0,0x2c(%eax,%edx,4)
80104d54:	00 
  fileclose(f);
...
8010534e:	e8 3d c4 ff ff       	call   80101790 <iunlock>
  iput(curproc->cwd);
80105353:	8b 46 6c             	mov    0x6c(%esi),%eax
...
80105363:	31 c0                	xor    %eax,%eax
  curproc->cwd = ip;
80105365:	89 5e 6c             	mov    %ebx,0x6c(%esi)
}
...
801054f5:	c7 44 98 2c 00 00 00 	movl   $0x0,0x2c(%eax,%ebx,4)
801054fc:	00 
    fileclose(rf);
...
8010555b:	78 13                	js     80105570 <sys_exitStatus+0x30>
...
80105563:	e8 58 e6 ff ff       	call   80103bc0 <exitStatus>
...
8010556c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
		exitStatus(1); //didn't receive an argument, so I'm forcefully sending a one
80105570:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105577:	e8 44 e6 ff ff       	call   80103bc0 <exitStatus>
}
...
801055b3:	78 13                	js     801055c8 <sys_waitStatus+0x38>
		return -1;
	else
		return waitStatus(argPtr);
801055b5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801055b8:	89 04 24             	mov    %eax,(%esp)
801055bb:	e8 f0 e8 ff ff       	call   80103eb0 <waitStatus>
}
801055c0:	c9                   	leave  
801055c1:	c3                   	ret    
...
801055d8:	8d 45 ec             	lea    -0x14(%ebp),%eax
801055db:	89 44 24 04          	mov    %eax,0x4(%esp)
801055df:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801055e6:	e8 b5 f2 ff ff       	call   801048a0 <argint>
	argPtr = argptr(1, (void*)&status, sizeof(int));
801055eb:	c7 44 24 08 04 00 00 	movl   $0x4,0x8(%esp)
801055f2:	00 
801055f3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
	argInt1 = argint(0, &pid);
801055fa:	89 c3                	mov    %eax,%ebx
	argPtr = argptr(1, (void*)&status, sizeof(int));
...
80105603:	c1 eb 1f             	shr    $0x1f,%ebx
	argPtr = argptr(1, (void*)&status, sizeof(int));
80105606:	e8 c5 f2 ff ff       	call   801048d0 <argptr>
	argInt2 = argint(2, &options);
...
8010561b:	e8 80 f2 ff ff       	call   801048a0 <argint>
	if (argInt1 < 0 || argPtr < 0 || argInt2 < 0)
80105620:	84 db                	test   %bl,%bl
80105622:	75 34                	jne    80105658 <sys_waitpid+0x88>
80105624:	89 f2                	mov    %esi,%edx
80105626:	c1 ea 1f             	shr    $0x1f,%edx
80105629:	84 d2                	test   %dl,%dl
8010562b:	75 2b                	jne    80105658 <sys_waitpid+0x88>
8010562d:	85 c0                	test   %eax,%eax
8010562f:	78 27                	js     80105658 <sys_waitpid+0x88>
		return -1;
	else
...
80105645:	e8 56 e9 ff ff       	call   80103fa0 <waitpid>
}
8010564a:	83 c4 20             	add    $0x20,%esp
8010564d:	5b                   	pop    %ebx
8010564e:	5e                   	pop    %esi
8010564f:	5d                   	pop    %ebp
80105650:	c3                   	ret    
...
8010565d:	eb eb                	jmp    8010564a <sys_waitpid+0x7a>
8010565f:	90                   	nop
...
80105683:	e8 78 ea ff ff       	call   80104100 <kill>
}
80105688:	c9                   	leave  
80105689:	c3                   	ret    
...
801056dc:	e8 ff e0 ff ff       	call   801037e0 <growproc>
...
8010578f:	e8 cc ed ff ff       	call   80104560 <release>
}
...
80105886:	66 a3 a6 4f 11 80    	mov    %ax,0x80114fa6
  initlock(&tickslock, "time");
8010588c:	e8 ef ea ff ff       	call   80104380 <initlock>
}
80105891:	c9                   	leave  
80105892:	c3                   	ret    
...
8010594e:	8b 55 e4             	mov    -0x1c(%ebp),%edx
            myproc()->pid, myproc()->name, tf->trapno,
80105951:	83 c6 70             	add    $0x70,%esi
    cprintf("pid %d %s: trap %d err %d on cpu %d "
...
80105960:	8b 40 14             	mov    0x14(%eax),%eax
...
80105978:	c7 40 28 01 00 00 00 	movl   $0x1,0x28(%eax)
8010597f:	90                   	nop
  }
...
8010598e:	8b 50 28             	mov    0x28(%eax),%edx
...
801059a5:	83 78 10 04          	cmpl   $0x4,0x10(%eax)
...
801059b9:	8b 40 28             	mov    0x28(%eax),%eax
...
80106752:	e8 59 de ff ff       	call   801045b0 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
80106a2d:	8b 56 0c             	mov    0xc(%esi),%edx
...
80106a4a:	8b 46 08             	mov    0x8(%esi),%eax
...
80106a5b:	5d                   	pop    %ebp
  popcli();
80106a5c:	e9 df d9 ff ff       	jmp    80104440 <popcli>
...
80106ac7:	e8 e4 da ff ff       	call   801045b0 <memset>
...
80106afb:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106afc:	e9 4f db ff ff       	jmp    80104650 <memmove>
...
80106c13:	e8 98 d9 ff ff       	call   801045b0 <memset>
...
80106d8b:	e8 20 d8 ff ff       	call   801045b0 <memset>
...
80106e7d:	e8 ce d7 ff ff       	call   80104650 <memmove>
...
80106fac:	e8 9f d6 ff ff       	call   80104650 <memmove>
    len -= n;
    buf += n;
